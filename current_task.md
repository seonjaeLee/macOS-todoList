...
- **Windows Phase 2** — 1~2차 피드백 반영 커밋 완료; **z-order(`3f4b52d`)는 아직 집 PC 재테스트 전**; `scripts/start-dev` Windows 경로·`widget.js` Ctrl 단축키 코드 반영 완료(집 PC 실기 확인 대기, `history.md` 2026-07-02)
